...
export class RightContent extends Component {
  ...
  render() {
    const { firstName, lastName, age, email, state, country, address, address1, address2, interests } = this.state.user;
    ...
    return (
      <div className="rightPanel">
        ...
        <div className="row">
          ...
          <div className="col-sm-6 mb-2">
            <input type="email" value={email} name="email" onChange={(e) => { this.inputChange(e)} } className="form-control" id="email" placeholder="user-name@gmail.com" />
